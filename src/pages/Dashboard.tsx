...
const DashboardPage: React.FC = () => {
  ...
  const fetchTripCountsDaily = async () => {
    try {
      ...
      const transformedData: TripCount[] = dailyData
        .map((item: any) => {
          try {
        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={2} sx={{ marginTop: "2rem", marginBottom: "2rem", justifyContent: "center" }}>
            <Grid item xs={12} sm={6} md={6} lg={6} sx={{ display: "flex", justifyContent: "center" }}>
              <Card sx={{ height: "400px", width: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", background: "#f0f0f0", borderRadius: "30px" }}>
                <CardContent>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} sx={{ display: "flex", justifyContent: "center" }}>
              <Card sx={{ height: "400px", width: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", background: "#f0f0f0", borderRadius: "30px" , marginLeft:"100px"}}>
                <CardContent>
                  <Typography variant="h6" gutterBottom>
                    Driver Status
                  </Typography>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} sx={{ display: "flex", justifyContent: "center" }}>
              <Card sx={{ height: "530px", width: "1300px", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", background: "#f0f0f0", borderRadius: "30px" }}>
                <CardContent>
                  <Typography variant="h6" gutterBottom>
